...
try{
  const response=await axios.post(`${URL}/post/addPostLikesAndComments`,data, {headers: {
      'Content-Type':'application/json',
      'Authorization': 'Bearer ' + token,
    }});
  return response;
...
try{
  ...
  const response=await axios.get(`${URL}/post/getPostLikesAndComments/${id}`, {headers: {
      'Content-Type':'application/json',
      'Authorization': 'Bearer ' + token,
    }})
...
try{
  const response=await axios.post(`${URL}/post/addUserLikedAndCommentedPosts`,data, {headers: {
      'Content-Type':'application/json',
      'Authorization': 'Bearer ' + token,
    }});
  return response;
...
try{
    ...
    const response = await axios.post(`${URL}/post/getUserLikedAndCommentedPosts`,data, {headers: {
      'Content-Type':'application/json',
      'Authorization': 'Bearer ' + token,
    }});
    return response;
